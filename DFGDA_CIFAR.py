...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 32, 3, 1)  # 3 input channels for CIFAR-10
...
class SimulatedAnnealing(Optimizer):
    def __init__(self, params, initial_temp=1.0, cooling_rate=0.995, min_temp=1e-3, sampler=None):
