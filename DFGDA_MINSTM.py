...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.relu4 = nn.ReLU()
        self.fc2 = nn.Linear(128, 10)  # 10 output classes for MNIST-M
...
train_dataset = torchvision.datasets.ImageFolder(root='./data/MNIST-M/training', transform=transform)
...
class GDAOptimizer_frac:
    def __init__(self, params, num_states=1024, initial_temp=1.0, initial_rate=0.995, f_min=1.0, f_max=1.0, window_size=10):
...
optimizer_GDA = GDAOptimizer_frac(model_GDA.parameters(), initial_temp=1.0, initial_rate=0.995)
